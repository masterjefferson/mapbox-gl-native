...
void MapWindow::keyPressEvent(QKeyEvent *ev)
{
    ...
    case Qt::Key_L: {
            ...
            m_map.setPaintProperty("routeCase", "line-color", QColor("green"));
            ...
            m_map.addIcon("label-arrow", QImage(":label-arrow.svg"));
            m_map.addIcon("label-background", QImage(":label-background.svg"));
